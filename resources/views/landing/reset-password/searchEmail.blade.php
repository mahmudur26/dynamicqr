        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-wrap">
                    <!-- Contact Form -->
                    <form class="form contact-form"  method="post" action="{{route('find-password-to-reset')}}">
                        @if(Session::has('message'))
                        <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('message') }}</p>
                        @endif
                        @csrf
                        <p class="table_caption">Let's search your email</p>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-4">
                                    <div class="actions text-center">
                                        <button type="submit" name="submit" class="btn btn-lg btn-contact-bg" title="Login to your account!">Search</button>
